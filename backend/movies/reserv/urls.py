...
from .views import ShowDetail,ShowList,UserCreate,Logout,UserDetail,CustomObtainAuthToken,show_venues,set_csrf_token,VenueDetail,ReservDetail,ReservationListView,ReservDestroy,ListVenues
